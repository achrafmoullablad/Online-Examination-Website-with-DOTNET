<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage2.master" AutoEventWireup="true" CodeFile="InfoJava.aspx.cs" Inherits="Java" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" Runat="Server">Java
</asp:Content>
	...
	<section id="about">
        ...
        <div class="container">
            <div class="row">
                ...
                <img src="images/JamesGosling.jpeg" class="img-responsive" />
					<p>Picture of James Gosling father ofJava</p>
